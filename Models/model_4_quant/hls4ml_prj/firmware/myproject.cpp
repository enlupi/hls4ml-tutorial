...
void myproject(
    ...
    nnet::conv_2d_cl<input_t, fused_convbn_0_result_t, config2>(input_2, layer2_out, w2, b2); // fused_convbn_0
    ...
    nnet::linear<layer23_t, layer24_t, linear_config24>(layer23_out, layer24_out); // output_dense_linear

    nnet::softmax<layer24_t, result_t, softmax_config25>(layer24_out, layer25_out); // output_softmax
