...
void myproject(
    ...
    nnet::conv_2d_cl<input_t, conv_0_result_t, config2>(input_1, layer2_out, w2, b2); // conv_0
    ...
    nnet::linear<layer26_t, layer27_t, linear_config27>(layer26_out, layer27_out); // output_dense_linear

    nnet::softmax<layer27_t, result_t, softmax_config28>(layer27_out, layer28_out); // output_softmax
